...
import 'package:sound_level_meter/feature/locations/location/bloc/location/bloc/product_location_bloc.dart';
                ...
                itemBuilder: (context, index) {
                  ...
                  return Padding(
                    ...
                    child: Card(
                      ...
                      color: Color(0xFF2C2C2C), // Темный фон для карточки
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // Перебор складов в этом городе
                                  // for (var warehouse in location.warehouses)
                                  //   Column(
                                  //     crossAxisAlignment: CrossAxisAlignment.start,
                                  //     children: [
                                  //       // Название склада
